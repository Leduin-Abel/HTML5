...
function listar(archivos){
    for (var i=0; i<archivos.length; i++){
        ...
        //pregunta si es un directorio
            ...
            //me permite acceder a lo que contiene el directorio al clicar en el
...
function volver(){
    ...
    espacio.getDirectory(ruta,null, function(dir_actual){
        ...
        //devuelve directorio padre
        //recibe dos parametros, que hacer si todo sale bien y que hacer si algo sale mal
        dir_actual.getParent(function(dir_padre){

            //fullPath me da la ruta completa del elemento
